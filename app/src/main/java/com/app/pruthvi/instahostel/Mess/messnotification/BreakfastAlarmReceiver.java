package com.app.pruthvi.instahostel.Mess.messnotification;
...
import com.app.pruthvi.instahostel.Account.SplashActivity;
...
public class BreakfastAlarmReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        builder.setSmallIcon(R.mipmap.icon_instahostel);
        builder.setLargeIcon(BitmapFactory.decodeResource(context.getResources(), R.mipmap.icon_instahostel));
