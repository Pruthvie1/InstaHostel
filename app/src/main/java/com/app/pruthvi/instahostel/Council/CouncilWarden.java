...
public class CouncilWarden extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CouncilUserClass TakshShila=new CouncilUserClass("Shashi Sir","TakshShila Boys Hostel Warden","7558708535","pruthvipatil610@gmail.com",R.drawable.ritik);
        CouncilUserClass TakshShila1=new CouncilUserClass("Shashi Sir.","TakshShila Girls Hostel Warden","7558708535","pruthvipatil610@gmail.com",R.drawable.ritik);


        wardenList.add(TakshShila);
        wardenList.add(TakshShila1);
