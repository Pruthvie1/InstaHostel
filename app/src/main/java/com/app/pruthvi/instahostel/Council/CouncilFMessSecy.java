...
public class CouncilFMessSecy extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CouncilUserClass messMem1=new CouncilUserClass("Karan Patil","Mess Committee","7558708535","",R.drawable.robert);
        CouncilUserClass messMem2=new CouncilUserClass("Shreyas Talpade","Mess Committee","7558708535","",R.drawable.stt);
