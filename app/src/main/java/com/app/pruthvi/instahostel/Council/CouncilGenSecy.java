...
public class CouncilGenSecy extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CouncilUserClass genAcSecy=new CouncilUserClass("Shruti Hassan","Academic General Secretary","7558708535","",R.drawable.sh);
        CouncilUserClass genCulSecy=new CouncilUserClass("Tiger Shroff","Cultural General Secretary","7558708535","",R.drawable.tiger);
